...
# Main
args = processArgs()
logging.basicConfig(level=logging.DEBUG if args.debugmode else logging.INFO, format='%(levelname)s %(asctime)s\t%(message)s')

# Bootstrap django (orm only)
os.environ['DJANGO_SETTINGS_MODULE'] = 'settings'
django.setup()
import db # noqa: E402 - Must follow django setup
